...
import isAndroidTablet     from './browser/isAndroidTablet'
import isChrome            from './browser/isChrome'
...
import isIPhone            from './browser/isIPhone'
import isIPod              from './browser/isIPod'
import isMobile            from './browser/isMobile'
import isSafari            from './browser/isSafari'
import isTablet            from './browser/isTablet'
import isTouchable         from './browser/isTouchable'
import isWindows           from './browser/isWindows'
...
import getSelectorAll      from './core/getSelectorAll'
...
import getAttr             from './dom/getAttr'
import getData             from './dom/getData'
import getHtml             from './dom/getHtml'
import getProp             from './dom/getProp'
import hasClass            from './dom/hasClass'
import html                from './dom/html'
import indexInParent       from './dom/indexInParent'
...
import getSize             from './styles/getSize'
